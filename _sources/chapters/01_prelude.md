...
Open Source doesn't just mean access to the source code. [Fundamental principles](https://opensource.org/osd) are defined by the Open Source Initiative. Closely related to this is the Open Science movement and the “[FAIR Principles](https://www.go-fair.org/fair-principles/)”, which have been instrumental in making scientific work transparent, collaborative and findable.
