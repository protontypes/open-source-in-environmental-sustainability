...
Our findings indicate that open source still plays a minor role within sustainability as a transformation strategy compared to other domains. Half of all identified projects are in data-rich fields such as climate science, biosphere, energy system modelling, transportation and buildings. Other topics, such as carbon offsets, battery technology, sustainable investment, emission observation and integrated assessment modelling, show few notable developments. Newly emerging topics, such as green software, were identified based on popularity growth. Most identified projects are relatively young, with a median age of 4.45 years. The programming languages Python and R dominate the ecosystem, while developers favour permissive licences such as MIT, followed by the copyleft licence GPLv3.
