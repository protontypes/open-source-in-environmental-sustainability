...
width: 70%
---
\- Open source software and Open Data are the foundation of many modern innovation processes. This artwork is generated by the open source artificial intelligence [Stable Diffusion](https://github.com/CompVis/stable-diffusion).
```
...
- The [Open Climate Community Calls](https://www.appropedia.org/Open_Climate), launched by the well known [Appropedia](https://www.appropedia.org/Welcome_to_Appropedia) commmunity, created worldwide connections between multiple individuals from different domains – to understand the [relationship](https://branch.climateaction.tech/issues/issue-2/open-climate-now/) between openness and climate change.
